...
func ProvideEngine(log *zap.Logger, cfg *config.Config, ks *keystore.Store, rt *runtime.Store, col *metrics.Collector) *gin.Engine {
	...
	router.Register(e, router.Deps{Config: cfg, Log: log, KeyStore: ks, Runtime: rt, Metrics: col})
