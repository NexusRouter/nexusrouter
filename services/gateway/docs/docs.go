...
const docTemplate = `{
            ...
            "post": {
                ...
                "responses": {
                    ...
                    "401": {
                        "description": "Unauthorized",
                        "schema": {
                            "$ref": "#/definitions/handler.GatewayErrorBody"
                        }
                    },
                    "502": {
    ...
    "definitions": {
        ...
        "handler.HealthResponse": {
            ...
            "properties": {
                "server_time": {
                    "type": "string",
                    "example": "2026-05-01T12:00:00.000000001Z"
                },
                "status": {
                    "type": "string",
                    "example": "ok"
    ...
    "externalDocs": {
        "description": "OpenAI API Overview",
